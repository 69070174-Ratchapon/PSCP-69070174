...
```text
รับinputมา input จะอยุ่ในบรรทัดเดียวกัน ผมใช้mapในการแยกinput ออกมา โดยinput1 จะเป็นจำนวนที่น้ำขยายไปต่อไปวินาที input2 เป็น จำนวนบ้านที่จะโดนน้ำท่วม แล้วก็ใส่พิกัดx,yเข้าไป แล้วก้็คำนวนว่าพิกัดนั้นจะโดนน้ำท่วมในวินาทีที่เท่าไร
```
...
```text
ตอนแรกให้ai ช่วยในการทำความเข้าใจโจทย์ แล้วก็พอเข้าโจทย์ ก็ทำการรับinputเข้ามา แล้วก็ใช้loopในการรับพิกัดของบ้านซึ่งจำนวนบ้านจะอยุ่ในinput2 แล้วก็หาระยะห่างระหว่างจุด0,0กับx,y แล้วก้ทำการคำนวนว่าบ้านจะโดนน้ำท่วมในวินาทีที่เท่าไรใช้สูตรคือ ค่าpi * (r**2[ซึ่งหาได้จากระยะห่างระหว่างจุด0,0กับx,y]) / ระยะที่น้ำจะกระจายได้ใน1วิ แล้้วก็ทำการแสดงผลลัพธ์แล้วก็ต้องใช้math.ceil ในการปัดขึ้น
```
...
```text
ตัวเลขเยอะๆแต่ไม่เกิน test case specification
```
