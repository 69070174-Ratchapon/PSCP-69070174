...
```text
อ่านค่าinputมาและทำการแสดงค่าจำนวนบวกที่10หารลงตัวทั้งหมด จากมากไปน้อยและในบรรทัดเดียวกัน
```
...
```text
step 1 : อ่านค่า
step 2 : เอาค่ามาทำให้ลงท้ายด้วย0 เช่นถ้าเป็น179 ทำให้เป็น170 โดยการเอา(179 // 10) * 10
step 3 : แสดงค่าที่มากที่สุดไปจนน้อยที่สุด 
```
...
```text
ใช้ for i in range(number,-1,-1) (numberเป็นค่าที่รับมา) แล้วก้ตั้งเงื่อนไขว่าถ้าเลขนั้นหาร10 ลงตัวทำการแสดงค่าออกมา
```
...
```text
inputเป็นเลขที่ลงท้ายด้วยเลขที่ไม่ใช่0
```
