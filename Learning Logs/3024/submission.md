...
```text
รับค่าinput1 = คะแนนรวมทั้งหมด input 2 = คะแนนมากที่สุด ถ้าคะแนนต่ำสุดกับคะแนนมากสุด มีโอกาสห่างกันมากกว่า2 คะแนนแสดงข้อความว่าSurprising แต่ถ้าไม่ แสดงข้อความว่าNot surprising
```
