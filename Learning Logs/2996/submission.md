...
```
รับค่ามาเป็นข้อความความยาว5ตัวอักษรและเปลี่ยนเป็นตัวอักษรตัวเล็กทั้งหมดและแสดงข้อความจากขวาไปซ้าย
input รับค่าจำนวนเต็มมา5ตัวอักษร
output: แสดงข้อความทั้งหมดแต่กลับเป็นขวาไปซ้าย
constraints: รับตัวอักษรมา5ตัวอักษรพอดี
```
...
```
step1: อ่านข้อความ
step2: เปลี่ยนอักษรตัวใหญ่เป็นตัวเล็ก
step3: แสดงข้อความจากขวาไปซ้าย
```
...
```
เหมือนกับแผนแรก รับข้อความมาแล้วแปลงตัวอักษรตัวใหญ่เป็นตัวเล็กและแสดงข้อความจากขวาไปซ้าย
```
...
```
ทดสอบว่าแสดงข้อความจากขวาไปซ้ายจริงไหม
```
...
```
ทดสอบว่าสลับตัวใหญ่เป็นตัวเล็กไหม
```
