...
```
รับinputเป็นจำนวนเต็มแล้วก้เอามาเพิ่มค่าบริการ10%ของinput อย่างต่ำ50และมากที่สุดคือ1000 แล้วก็นำไปบวกกับvat 7%ของค่าที่บวกกับค่าบริการแล้วและแสดงค่าออกมา constraints คือ input ต้องเป็นจำนวนเต็ม
```
...
```
step 1: อ่านค่า
step2 : เอาค่าที่อ่านได้ไปคูณกับ10% ของค่าที่อ่านได้ จะได้ค่าบริการ
step3 : ถ้าค่าบริการได้น้อยกว่าหรือเท่ากับ50 ค่าบริการคือ 50
step4 : ถ้าค่าบริการมากกว่า 1000 ค่าบริการคือ 1000
step5 : เอาค่าบริการมาบวกกับค่าที่อ่านได้
step6 : เอาค่าที่ได้จากstep5 มาบวกอีก7%ของค่าที่ได้จากstep5 และแสดงผล
```
...
```
เหมือนกับแผนแรก แล้วก็outputก้ทำให้เป็นทศนิยม2หลัก
```
...
```
กรณีที่ค่าบริการอยู่ระหว่าง50 กับ 1000
```
