...
| OJ submission ID, if submitted | 565731 |
| OJ status | Pass |
...
```text
หาข้อผิดพลาดของcode และให้ช่วยตั้งสมการให้
```
...
```text
ลืมว่าถ้าinput2 = input 3 จะต้องแสดงค่าอุณหภูมิตอนแรก 
```
...
```text
ให้มีความรอบคอบมากกว่านี้
ควรตั้งสมการเองให้ได้
