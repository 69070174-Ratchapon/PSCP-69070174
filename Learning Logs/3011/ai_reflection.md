...
| OJ submission ID, if submitted | 544221 |
| OJ status | Pass |
...
```
conditionที่ขาด คือ ขาด input แบบเดียวกัน
```
...
```
กลับไปดู code และเพิ่ม condition ที่มีสีสีเดียวกัน
```
...
```
ควรวิเคราะห์โจทย์ก่อนจะลงมือทำ
ได้เรียนรู้ว่าการสร้างเงื่อนไข if elif else ให้ครอบคลุมทุกกรณี
```
