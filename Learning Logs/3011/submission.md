...
```
รับinputมา2ค่า เป็นสีแดงหรือเหลืองหรือฟ้า อีกค่านึงคือสีแดงหรือเหลืองหรือฟ้าเหมือนกัน output คือสีที่ผสมกันระหว่าง input ทั้ง2ค่า constraints:ต้องเป็นสีแดงหรือเหลืองหรือฟ้าเท่านั้น
```
...
```
step 1: สร้างตัวแปรรับค่าสองค่า
step 2:เข้าเงื่อนไขการผสมสีของทั้งสองสีโดยสีแดงกับสีเหลืองคือส้ม แดงกับฟ้าคือม่วง เหลืองกับฟ้าคือเขียว
step 3: ถ้ามีสีที่ไม่ใช่3สีนี้ print("Error")
```
...
```
เหมือนกับวิธีแรกที่คิดแต่แค่เพิ่มconditionที่มีinputเป็นสีเดียวกันoutputก็จะเป็นสีนั้น เช่น red กับ red output ก็คือ red
```
